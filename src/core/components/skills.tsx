...
export const Skills = (skill: ISkills) => {
  return (
    <GridItem margin="auto" height="164px" width="164px">
      <Flex height="full" width="full" flexDirection="column" alignItems="center" justifyContent="Center" gap={6}>
        <Text textColor="white" fontWeight="bold" fontSize="20px">{skill.title}</Text>
        <IconButton aria-label="icons-ib"
          variant="none"
          _hover={{
            transform: "scale(1.2)",
